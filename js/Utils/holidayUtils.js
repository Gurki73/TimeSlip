...
const germanFixedHolidays = [
    ...
    { name: "Mariä Himmelfahrt", emoji: "👑", day: 15, month: 8, bundesländer: ["Bavaria", "Saarland"] },
    { name: "Reformationstag", emoji: "📜", day: 31, month: 10, bundesländer: ["Brandenburg", "Mecklenburg-Vorpommern", "Saxony", "Saxony-Anhalt", "Thuringia"] },
    { name: "Allerheiligen", emoji: "🌺", day: 1, month: 11, bundesländer: ["Baden-Württemberg", "Bavaria", "North Rhine-Westphalia", "Rhineland-Palatinate", "Saarland"] },
    { name: "Fronleichnam", emoji: "⛪", day: 8, month: 6, bundesländer: ["Bavaria", "Hesse", "North Rhine-Westphalia", "Rhineland-Palatinate", "Saarland"] },
    { name: "Dreikönigstag", emoji: "👑", day: 6, month: 1, bundesländer: ["Bavaria", "Baden-Württemberg", "Saxony-Anhalt" ]},
  ];
  ...
  const germanVariableHolidays = [
    ...
    { name: "Buß- und Bettag", emoji: "🙏", offset: -7, bundesländer: ["Saxony"] },
  ];
  ...
  function getHolidayDetails(date, state) {
    ...
    if (fixedHoliday) {
      return { emoji: fixedHoliday.emoji, name: fixedHoliday.name };
    }
    ...
    return variableHoliday
      ? { emoji: variableHoliday.emoji, name: variableHoliday.name }
      : null;
  }
  ...
  function nonOfficialHolidays(year, state) {
    ...
    const fixedHolidays = [
        { name: "Walpurgisnacht", emoji: "🧙‍♀️", day: 30, month: 4, bundesländer: ["Thuringia", "Lower Saxony"], renderOnly: true },
    ...
    const dynamicHolidays = [
        {
            ...
            emoji: "🤡",
            offset: -47,
            bundesländer: ["North Rhine-Westphalia", "Hesse", "Rhineland-Palatinate"],
            renderOnly: true
        },
        {
            name: "Oktoberfest",
